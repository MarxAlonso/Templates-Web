import type { UniversidadConfig } from "@/types";

export const universidades: UniversidadConfig[] = [
  {
    nombre: "UCV",
    slug: "tesis-ucv",
    nombreCompleto: "Universidad César Vallejo",
    primaryColor: "#00bfaf",
    primaryRgba: "rgba(0, 191, 175, 0.05)",
    hero: {
      preTitle: "Guía de Investigación UCV",
      h1: 'Guía Definitiva: Cómo terminar tu <strong>tesis de la Universidad César Vallejo</strong> sin morir en el intento',
      descripcion:
      ...
      floatingCards: [
        {
          icon: "📝",
          iconBg: "#e6fcf9",
          titulo: "Asesoría APA UCV",
          descripcion: "Adaptamos tu tesis al formato oficial de la UCV.",
        },
        {
          icon: "🛡️",
          iconBg: "#e6f0fc",
          titulo: "Turnitin Bajo",
          descripcion: "Garantizamos menos del 20% de similitud.",
        },
        {
          icon: "🎓",
          iconBg: "#f4e6fc",
          titulo: "Plan de Tesis",
          descripcion: "Aprobación rápida de tu proyecto.",
        },
      ],
    },
    conversion: {
      tagEquipo: "Tu éxito es nuestra meta",
      h2: 'El laberinto de la investigación: ¿Por qué la <strong>César Vallejo tesis</strong> parece un reto imposible?',
      descripcion:
        "Seamos honestos: el camino hacia el título profesional está lleno de baches metodológicos y curvas de APA que nadie te enseñó a tomar. Para muchos vallejianos, la <strong>César Vallejo tesis</strong> se convierte en una sombra que los persigue.",
      beneficios: [
        { texto: "<strong>Aterrizamos tus ideas:</strong> En una matriz de consistencia sólida." },
        { texto: "<strong>Equipo experto:</strong> Hablamos tu mismo idioma académico." },
        { texto: "<strong>Ahorro de tiempo:</strong> Disfruta tu vida mientras nosotros avanzamos." },
      ],
      ...
      expertos: [
        {
          imagen: "https://scribbr-res.cloudinary.com/image/upload/q_auto,f_auto,w_150/v1619441113/team/samantha.png",
          alt: "Asesor Tesis UCV",
          nombre: "Samantha",
    ...
    facultades: [
      {
        icono: "🏗️",
        titulo: "Tesis de Ingeniería y Arquitectura",
        descripcion: "Asesoría en Ingeniería Civil, Industrial y Sistemas. Expertos en metodologías ágiles y gestión de proyectos para la <strong>UCV</strong>.",
      },
      {
        icono: "⚕️",
        titulo: "Tesis de Ciencias de la Salud",
        descripcion: "Especialistas en Enfermería, Psicología y Estomatología. Aplicamos rigurosamente las <strong>Normas Vancouver</strong> exigidas por la UCV.",
      },
      {
        icono: "⚖️",
        titulo: "Tesis de Derecho y Humanidades",
        descripcion: "Desarrollo de tesis jurídicas, educación y ciencias de la comunicación. Dominio total de la argumentación y <strong>APA 7ma Edición</strong>.",
      },
      {
        icono: "📊",
        titulo: "Tesis de Ciencias Empresariales",
        descripcion: "Asesoría en Administración, Contabilidad y Marketing. Análisis estadísticos con SPSS y planes de negocio escalables.",
      },
    ],
    autoridad: {
      badge: "Cimientos de Acero",
      h2: 'Los pilares de tu éxito en la <strong>tesis universidad César Vallejo</strong>',
      descripcion: "En la UCV, la exigencia ha subido de nivel, y nosotros nos hemos adaptado a ella con rigor y originalidad.",
      datos: [
        { titulo: "Rigor Metodológico:", descripcion: "Tu brújula académica para no perderte." },
        { titulo: "Filtro Turnitin:", descripcion: "Limpiamos el camino de la originalidad (APA 7)." },
      ...
      docLineas: [
        { texto: "El presente trabajo de investigación se ajusta a las líneas de ", corregido: "Gerencia Pública", original: "marketing", textoFinal: " de la UCV..." },
        { texto: "Se aplicó el instrumento de recolección de datos considerando una población de ", corregido: "120", original: "50", textoFinal: " sujetos según la fórmula de..." },
      ],
      commentBubble: {
        avatar: "https://i.pravatar.cc/100?img=5",
        avatarAlt: "Asesor Senior UCV",
        nombre: "Mg. Alexander",
        texto: "Recuerda que para la UCV, el índice de similitud no debe superar el 20% en Turnitin. He ajustado el parafraseo.",
      },
    },
    faq: [
      {
      ...
      floatingCards: [
        {
          icon: "📚",
          iconBg: "#e6f0fc",
          titulo: "Rigor Académico",
          descripcion: "Investigación con estándares de excelencia.",
        },
        {
          icon: "📝",
          iconBg: "#e6fcf9",
          titulo: "Normas APA 7",
          descripcion: "Precisión en citas y referencias.",
        },
        {
          icon: "🎯",
          iconBg: "#f4e6fc",
          titulo: "Metodología",
          descripcion: "Cualitativa, cuantitativa o mixta.",
        },
      ],
    },
    conversion: {
      tagEquipo: "Tu éxito es nuestra meta",
      h2: 'La importancia de una estructura sólida: El cimiento de tu <strong>tesis PUCP</strong>',
      descripcion:
        "Imagina que intentas construir un edificio en la Av. Universitaria sin planos. ¿Suena a desastre, verdad? Para dominar la <strong>tesis PUCP</strong>, el primer paso es entender que no se trata solo de escribir mucho, sino de escribir con propósito.",
      beneficios: [
        { texto: "<strong>Coherencia metodológica:</strong> Entre problema, objetivos y metodología." },
        { texto: "<strong>Densidad conceptual:</strong> Cada párrafo aporta valor real." },
        { texto: "<strong>Precisión en citas:</strong> Separando lo mediocre de lo sobresaliente." },
      ],
      ...
      expertos: [
        {
          imagen: "https://i.pravatar.cc/100?img=12",
          alt: "Asesor Tesis PUCP",
          nombre: "Carlos",
          especialidad: "Investigador Senior",
        },
        {
          imagen: "https://i.pravatar.cc/100?img=25",
          alt: "Editora APA PUCP",
          nombre: "Lucía",
          especialidad: "Especialista en APA",
        },
      ],
    },
    facultades: [
      {
        icono: "⚖️",
        titulo: "Tesis de Derecho",
        descripcion: "Argumentación jurídica sólida, análisis normativo y doctrina actualizada para la <strong>PUCP</strong>.",
      },
      {
        icono: "🏛️",
        titulo: "Tesis de Ingeniería",
        descripcion: "Ingeniería Civil, Mecánica, Química e Industrial con enfoque en innovación y sostenibilidad.",
      },
      {
        icono: "💼",
        titulo: "Tesis de Negocios",
        descripcion: "Administración, economía y finanzas con análisis cuantitativo riguroso.",
      },
      {
        icono: "🧠",
        titulo: "Tesis de Psicología",
        descripcion: "Investigación cualitativa y cuantitativa en salud mental y comportamiento humano.",
      },
    ],
    autoridad: {
      badge: "Propuesta de Valor",
      h2: '¿Por qué conformarse con lo básico cuando puedes marcar un <strong>hito académico</strong>?',
      descripcion: "La perplejidad en un texto académico —esa capacidad de presentar ideas complejas de forma fascinante— es lo que cautiva a los jurados en la sustentación de la tesis PUCP.",
      datos: [
        { titulo: "Rigor Académico:", descripcion: "Densidad conceptual y claridad metodológica." },
        { titulo: "Normas APA 7:", descripcion: "Precisión en citas y referencias oficiales." },
      ...
      docLineas: [
        { texto: "El enfoque metodológico prioriza la ", corregido: "coherencia interna", original: "improvisación", textoFinal: " entre las variables de estudio..." },
        { texto: "El análisis se realizó considerando una muestra de ", corregido: "250", original: "100", textoFinal: " participantes según criterios de inclusión..." },
      ],
      commentBubble: {
        avatar: "https://i.pravatar.cc/100?img=8",
        avatarAlt: "Asesor Senior PUCP",
        nombre: "Dr. Ramírez",
        texto: "Recuerda que la PUCP exige un nivel de densidad conceptual superior. He reforzado el marco teórico.",
      },
    },
    faq: [
      {
      ...
      floatingCards: [
        {
          ...
          descripcion: "Enfoque preciso como reloj suizo.",
        },
        {
          icon: "🛡️",
          iconBg: "#e6f0fc",
          titulo: "Filtro Turnitin",
          descripcion: "Originalidad bajo normas APA.",
        },
        {
          icon: "🔗",
          iconBg: "#f4e6fc",
          titulo: "Coherencia Interna",
          descripcion: "Objetivos, problemas y conclusiones alineados.",
        },
      ],
    },
    conversion: {
      tagEquipo: "Tu éxito es nuestra meta",
      h2: '¿Por qué la <strong>UPC tesis</strong> se siente como un maratón cuesta arriba?',
      descripcion:
        "En la UPC, el nivel de rigurosidad no es un mito. La estructura de la UPC tesis demanda una coherencia que no deja espacio para la improvisación. Si los cimientos están débiles, todo el proyecto se vendrá abajo al primer sismo de correcciones.",
      beneficios: [
        { texto: "<strong>Matriz de consistencia:</strong> Cimientos sólidos para tu investigación." },
      ...
      expertos: [
        {
          imagen: "https://i.pravatar.cc/100?img=33",
          alt: "Asesor Tesis UPC",
          nombre: "Miguel",
          especialidad: "Talleres de Investigación",
        },
        {
          imagen: "https://i.pravatar.cc/100?img=47",
          alt: "Especialista Turnitin UPC",
          nombre: "Andrea",
          especialidad: "Originalidad APA",
        },
      ],
    },
    facultades: [
      {
        icono: "💻",
        titulo: "Tesis de Ingeniería y Sistemas",
        descripcion: "Ingeniería de Software, Sistemas y Computación con metodologías ágiles y tecnologías actuales.",
      },
      {
        icono: "📈",
        titulo: "Tesis de Negocios",
        descripcion: "Administración, marketing y finanzas con análisis estadístico SPSS y planes de negocio.",
      },
      {
        icono: "🎨",
        titulo: "Tesis de Diseño y Comunicación",
        descripcion: "Diseño gráfico, comunicación corporativa y publicidad con enfoque creativo.",
      },
      {
        icono: "🏥",
        titulo: "Tesis de Ciencias de la Salud",
        descripcion: "Medicina Humana, Nutrición y Terapia Física con investigación clínica rigurosa.",
      },
    ],
    autoridad: {
      badge: "Alianza Estratégica",
      h2: 'Más que una asesoría, una <strong>alianza estratégica</strong> para tu tesis',
      descripcion: "Nos subimos al barco contigo. Entendemos que cada carrera en la UPC tiene su propia personalidad. No usamos plantillas genéricas.",
      datos: [
        { titulo: "Rigor Metodológico:", descripcion: "El motor de tu investigación, preciso como un reloj." },
        { titulo: "Filtro Turnitin:", descripcion: "Tu pase a la libertad, originalidad garantizada." },
...
export function getUniversidadBySlug(slug: string): UniversidadConfig | undefined {
  return universidades.find((u) => u.slug === slug);
}

export function getAllSlugs(): string[] {
  return universidades.map((u) => u.slug);
}
